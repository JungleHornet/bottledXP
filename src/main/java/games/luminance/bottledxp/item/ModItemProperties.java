...
public class ModItemProperties {
    public static void addCustomItemProperties() {
        ItemProperties.register(ModItems.ADVANCED_CAPSULE.get(), ResourceLocation.fromNamespaceAndPath(BottledXP.MODID, "has_xp"), (itemStack, clientLevel, livingEntity, i) -> {
